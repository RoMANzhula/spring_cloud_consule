package org.romanzhula.bookstoreproductservice.configurations;
...
public class ConsulConfig {
    ...
    public String getDbUrl() {
        ...
        String url = kvClient.getValueAsString("config/product-service,default/spring.datasource.url")
    ...
    public String getDbUsername() {
        ...
        String username = kvClient.getValueAsString("config/product-service,default/spring.datasource.username")
    ...
    public String getDbPassword() {
        ...
        String password = kvClient.getValueAsString("config/product-service,default/spring.datasource.password")
